...
from outward.profile import Profile, load_profile, profile_exists, save_profile
...
def show() -> None:
    ...
    if not profile_exists():
        console.print("[yellow]No profile found. Run [cyan]outward profile setup[/cyan] first.[/yellow]")
        return
...
def edit(field_name: str, value: str) -> None:
    """Update a single profile field. Example: outward profile edit age 28"""
