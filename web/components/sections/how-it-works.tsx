const steps = [
  {
    ...
    description:
      'One terminal command installs Clap Cheeks on your Mac. No Homebrew dependencies, no Docker, no configuration files. It unpacks, sets up the local agent, and opens your dashboard.',
  ...
  },
  {
    ...
    description:
      'Link Tinder, Bumble, and Hinge through secure OAuth. Grant iMessage access so Clap Cheeks can read your tone. It takes 5 minutes to learn your style — then it builds your preference profile silently.',
    detail: 'Your credentials are stored in your Mac\'s Keychain, not our servers.',
  },
  {
    number: '03',
    title: 'Let Clap Cheeks handle it',
    description:
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-white/45 text-lg max-w-lg mx-auto leading-relaxed">
            No technical knowledge required. If you can open Terminal, you can run Clap Cheeks.
          </p>
        </div>
